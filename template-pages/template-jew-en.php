        ...
        if (have_posts()){
            while (have_posts()){
                ...
                <ul class="nav nav-tabs">
                    <li class="squ squ-1 squ-jew"><?php the_post_thumbnail('medium'); ?></li>
                    <li class="squ squ-mobile squ-mobile-en" style="background-color: #5a7772"><span><?php the_title(); ?></span></li>
                    <li class="squ squ-jew-2">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/programs/haredim02.png"); ?></li>
                    <li class="squ squ-jew-3"><img src="<?php echo get_template_directory_uri(); ?>/images/programs/haredim03.png"); ?></li>

        ...
        if (have_posts()){
            while (have_posts()){
                ...
                <ul class="nav nav-tabs">
                    <li class="squ squ-1 squ-golocal"><?php the_post_thumbnail('medium'); ?></li>
                    <li class="squ squ-mobile squ-mobile-en" style="background-color: #478576"><span><?php the_title(); ?></span></li>
                    <li class="squ squ-golocal-2">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/programs/go_local02.png"); ?></li>
                    <li class="squ squ-golocal-3">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/programs/go_local03.png"); ?></li>

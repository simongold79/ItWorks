    ...
    <ul class="nav nav-tabs">
        <li class="active squ squ-1">
            <a data-toggle="tab" href="#home">
                <div class="desktop-menu-li">
                    <img class="img-not-act" src="<?php echo get_template_directory_uri(); ?>/images/about/Ar/vision.png"); ?>
                    <img class="img-act" src="<?php echo get_template_directory_uri(); ?>/images/about/Ar/vision02.png"); ?>
                </div>
        ...
        <li class="squ squ-2">
            <a data-toggle="tab" href="#menu1">
                <div class="desktop-menu-li">
                    <img class="img-not-act" src="<?php echo get_template_directory_uri(); ?>/images/about/Ar/team.png"); ?>
                    <img class="img-act" src="<?php echo get_template_directory_uri(); ?>/images/about/Ar/team02.png"); ?>
                </div>
        ...
        <li class="squ squ-3">
            <a data-toggle="tab" href="#menu2">
                <div class="desktop-menu-li">
                    <img class="img-not-act" src="<?php echo get_template_directory_uri(); ?>/images/about/Ar/management.png"); ?>
                    <img class="img-act" src="<?php echo get_template_directory_uri(); ?>/images/about/Ar/management02.png"); ?>
                </div>
        ...
        <li class="squ squ-4">
            <a data-toggle="tab" href="#menu3">
                <div class="desktop-menu-li">
                    <img class="img-not-act" src="<?php echo get_template_directory_uri(); ?>/images/about/Ar/docs.png"); ?>
                    <img class="img-act" src="<?php echo get_template_directory_uri(); ?>/images/about/Ar/docs02.png"); ?>
                </div>

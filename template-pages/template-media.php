  ...
  <ul class="nav nav-tabs">
    <li class="active squ squ-1">
        <a data-toggle="tab" href="#home">
            <div class="desktop-menu-li">
                <img class="img-not-act" src="<?php echo get_template_directory_uri(); ?>/images/media/He/video.png"); ?>
                <img class="img-act" src="<?php echo get_template_directory_uri(); ?>/images/media/He/video02.png"); ?>
            </div>
    ...
    <li class="squ squ-2">
        <a data-toggle="tab" href="#menu1">
            <div class="desktop-menu-li">
                <img class="img-not-act" src="<?php echo get_template_directory_uri(); ?>/images/media/He/pics.png"); ?>
                <img class="img-act" src="<?php echo get_template_directory_uri(); ?>/images/media/He/pics02.png"); ?>
            </div>
    ...
    <li class="squ squ-3">
        <a data-toggle="tab" href="#menu2">
            <div class="desktop-menu-li">
                <img class="img-not-act" src="<?php echo get_template_directory_uri(); ?>/images/media/He/news.png"); ?>
                <img class="img-act" src="<?php echo get_template_directory_uri(); ?>/images/media/He/news02.png"); ?>
            </div>

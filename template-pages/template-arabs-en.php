        ...
        if (have_posts()){
            while (have_posts()){
                ...
                <ul class="nav nav-tabs">
                    <li class="squ squ-1 squ-arabs"><?php the_post_thumbnail('medium'); ?></li>
                    <li class="squ squ-mobile squ-mobile-en" style="background-color: #739d93"><span><?php the_title(); ?></span></li>
                    <li class="squ squ-arabs-2">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/programs/aravit02.png"); ?></li>
                    <li class="squ squ-arabs-3"><img src="<?php echo get_template_directory_uri(); ?>/images/programs/aravit03.png"); ?></li>
                    <li class="squ squ-4 squ-4-img squ-4-en"><img src="<?php echo get_template_directory_uri(); ?>/images/programs/pic.png"); ?></li>

    ...
    <ul class="nav nav-tabs">
        <li class="active squ squ-1">
            <a data-toggle="tab" href="#home">
                <div class="desktop-menu-li">
                    <img class="img-not-act" src="<?php echo get_template_directory_uri(); ?>/images/findJob/Ar/open.png"); ?>
                    <img class="img-act" src="<?php echo get_template_directory_uri(); ?>/images/findJob/Ar/open02.png"); ?>
                </div>
        ...
        <li class="squ squ-2">
            <a data-toggle="tab" href="#menu1">
                <div class="desktop-menu-li">
                    <img class="img-not-act" src="<?php echo get_template_directory_uri(); ?>/images/findJob/Ar/cv.png"); ?>
                    <img class="img-act" src="<?php echo get_template_directory_uri(); ?>/images/findJob/Ar/cv02.png"); ?>
                </div>
                <div class="mobile-menu-li mobile-menu-li-2 mobile-menu-li-ar"><span><?php _e(the_field('upload_cv')) ?></span></div>
            </a>
        </li>
        <li class="squ squ-3">
            <a data-toggle="tab" href="#menu2">
                <div class="desktop-menu-li">
                    <img class="img-not-act" src="<?php echo get_template_directory_uri(); ?>/images/findJob/Ar/tips.png"); ?>
                    <img class="img-act" src="<?php echo get_template_directory_uri(); ?>/images/findJob/Ar/tips02.png"); ?>
                </div>
                <div class="mobile-menu-li mobile-menu-li-3 mobile-menu-li-ar"><span><?php _e(the_field('tips')) ?></span></div>
            </a>
        </li>
                ...
                <div class="content">
                    <div class="blog-post">
                        <div class="position-mobile position-text-div">
                            <p class="position position-text position-num"> المركز رقم <?php _e(the_field('position_num')) ?></p>
                            <p class="position position-text blog-post-title"><?php the_title(); ?></p>
                        </div>
                        <div class="position position-mobile position-button-div">
                            <button class="position-button button" data-modal="<?php the_ID();?>"><span>مزيد من التفاصيل</span></button>
                            <a class="position-button position-cv" data-toggle="tab" href="#menu1"><span>تقديم الترشيح</span></a>
                        </div>
                    </div><!-- /.blog-post -->
                        ...
                        <div class="modal-content">
                            <div class="contact-form">
                                ...
                                <div class="popup-details popup-text">
                                    <p> المركز رقم <?php _e(the_field('position_num')) ?></p>
                                    <p><?php the_title(); ?></p>
                                    <p><?php _e(the_field('position_details')) ?></p>
                                    <a class="position-popup-btn" data-toggle="tab" href="#menu1">تقديم الترشيح</a>
                                </div>
                            </div>
                        </div>
                    </div>

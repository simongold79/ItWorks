        ...
        if (have_posts()){
            while (have_posts()){
                ...
                <ul class="nav nav-tabs">
                    <li class="squ squ-1 squ-goodcause"><?php the_post_thumbnail('medium'); ?></li>
                    <li class="squ squ-mobile squ-mobile-en" style="background-color: #969ea0"><span><?php the_title(); ?></span></li>
                    <li class="squ squ-goodcause-2">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/programs/matara02.png"); ?></li>
                    <li class="squ squ-goodcause-3">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/programs/matara03.png"); ?></li>

        ...
        if (have_posts()){
            while (have_posts()){
                ...
                <ul class="nav nav-tabs">
                    <li class="squ squ-1 squ-worthbus"><?php the_post_thumbnail('medium'); ?></li>
                    <li class="squ squ-mobile squ-mobile-en" style="background-color: #659597"><span><?php the_title(); ?></span></li>
                    <li class="squ squ-worthbus-2">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/programs/esek02.png"); ?></li>
                    <li class="squ squ-worthbus-3">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/programs/esek03.png"); ?></li>

<?php
/*
Template Name: Diversity works En
*/
?>
        ...
        if (have_posts()){
            while (have_posts()){
                ...
                <ul class="nav nav-tabs">
                    <li class="squ squ-1 squ-diver"><?php the_post_thumbnail('medium'); ?></li>
                    <li class="squ squ-mobile squ-mobile-en" style="background-color: #62c7a5"><span><?php the_title(); ?></span></li>
                    <li class="squ squ-diver-2">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/programs/deversity02.png"); ?></li>
                    <li class="squ squ-diver-3">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/programs/deversity03.png"); ?></li>

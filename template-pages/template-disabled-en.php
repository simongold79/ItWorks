        ...
        if (have_posts()){
            while (have_posts()){
                ...
                <ul class="nav nav-tabs">
                    <li class="squ squ-1 squ-dis"><?php the_post_thumbnail('medium'); ?></li>
                    <li class="squ squ-mobile squ-mobile-en" style="background-color: #7c9c73"><span><?php the_title(); ?></span></li>
                    <li class="squ squ-dis-2">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/programs/mugalut02.png"); ?></li>
                    <li class="squ squ-dis-3"><img src="<?php echo get_template_directory_uri(); ?>/images/programs/mugalut03.png"); ?></li>

        ...
        if (have_posts()){
            while (have_posts()){
                ...
                <ul class="nav nav-tabs">
                    <li class="squ squ-1 squ-halfway"><?php the_post_thumbnail('medium'); ?></li>
                    <li class="squ squ-mobile squ-mobile-en" style="background-color: #5a7772"><span><?php the_title(); ?></span></li>
                    <li class="squ squ-halfway-2">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/programs/emsa02.png"); ?></li>
                    <li class="squ squ-halfway-3"><img src="<?php echo get_template_directory_uri(); ?>/images/programs/emsa03.png"); ?></li>
